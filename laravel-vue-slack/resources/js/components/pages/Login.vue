<template>
  <div class="w-10/12 m-auto text-center">
    ...
    <div class="w-96 m-auto text-left pt-8">
      ...
      <sign-in-form-text  class="mb-2" type="text" v-model="email" name="email" id="email" placeholder="name@example.com" />
      <sign-in-form-label class="mb-2" forText="password" showText="Password" />
      <sign-in-form-text  class="mb-5" type="password" v-model="password" name="password" id="password" placeholder="Your password" />
...
import { UserSignIn, FetchUsers } from '../../apis/signIn.api.js'
